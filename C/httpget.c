...
void http_get(httpclient *h, char *command, char *parameters)
{
	...
	h->portno = 8080;
	h->host = "localhost";
	h->getformat = "GET /IOBoardV1/ControllerConsole?%s%s HTTP/1.0\r\n\r\n";
...
void jsonWriteChannel(httpclient *h, int modul, int id, int devid, unsigned char value)
{
	char params[100];

	sprintf(params, "&modul=%d&id=%d&devid=%d&value=%d", modul, id, devid, value);
...
//printf("%s\n", h.json);
	...
	modul = (json_object_object_get_ex(jobj, "modul", &val)?json_object_get_int(val):-1);
...
unsigned char jsonChannelGetValue(httpclient *h, int modul, int id, int devid)
{
	char params[100];

	sprintf(params, "&modul=%d&id=%d&devid=%d", modul, id, devid);
	http_get(h, "channel", params);
//printf("%s\n", h.json);
...
void jsonWriteBit(httpclient *h, int modul, int id, int devid, unsigned char value)
{
	char params[100];
...
unsigned char jsonBitGetValue(httpclient *h, int modul, int id, int devid)
{
	char params[100];
...
void jsonWritePulse(httpclient *h, int modul, int id, int devid, unsigned char value)
{
	char params[100];
...
unsigned char jsonPulseGetValue(httpclient *h, int modul, int id, int devid)
{
	char params[100];
...
unsigned char jsonWriteChannelPulse(httpclient *h, int modul, int id, int devid)
{
	char params[100];

	sprintf(params, "&modul=%d&id=%d&devid=%d", modul, id, devid);
	http_get(h, "channelpulse", params);
//printf("%s\n", h.json);
...
unsigned char jsonReadChannel(httpclient *h, int modul, int id, int devid)
{
	char params[100];
